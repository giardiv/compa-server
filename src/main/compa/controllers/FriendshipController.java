...
public class FriendshipController extends Controller {
    ...
    public FriendshipController(Container container) {
        ...
        this.registerAuthRoute(HttpMethod.POST, "/response", this::respondToRequest, "application/json");
    ...
    private void respondToRequest(User me, RoutingContext routingContext){
