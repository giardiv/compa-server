...
public class ImageException extends Exception{
     ...
     */
    public static final Pair<Integer, String> IO_EXCEPTION = new Pair<>(3002, "IO Exception");

    /**
     * @apiDefine UnacceptedFormat
     * @apiError UnacceptedFormat The format isnot accepted, i.e different than png or jpeg
     */
    public static final Pair<Integer, String> UNACCEPTED_FORMAT = new Pair<>(3003, "Format {0} is unacceptable !");
